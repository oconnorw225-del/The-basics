...
class EmailNotifier:
    ...
    def __init__(self):
        self.notifications_dir = Path("/home/runner/work/The-basics/The-basics/notifications")
    ...
    def _save_queue(self) -> None:
        ...
        self.outgoing_file.write_text(json.dumps(self.outgoing_queue, indent=2))
...
"""
    ...
    def gatekeeper_alert(self, missing_gatekeepers: List[str]) -> None:
        ...
        gatekeeper_list = "\n".join([f"  • {gk}" for gk in missing_gatekeepers])
...
"""
    ...
    def system_alert(self, alert_type: str, message: str, details: Optional[Dict] = None) -> None:
    ...
    def mark_as_sent(self, notification_id: str) -> bool:
        ...
        for notif in self.outgoing_queue:
            if notif["id"] == notification_id:
                ...
                self.outgoing_queue = [n for n in self.outgoing_queue if n["id"] != notification_id]

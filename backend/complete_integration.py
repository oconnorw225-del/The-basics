...
class CompleteIntegrationSystem:
    ...
    async def initialize(self) -> dict:
        ...
        try:
            ...
            credential_sharing.import_from_scanner(credential_scanner.discovered_credentials)
            ...
            if missing_gatekeepers:
                print(f"⚠️ Missing gatekeeper credentials: {missing_gatekeepers}")
            ...
            print("=" * 60)
            print(f"  • Credentials found: {init_results['credentials_found']}")
